...
import { PlayCircle, PauseCircle, Zap, Shield, Coins, Users } from 'lucide-react';
...
export default function DemoPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      <div className="relative aspect-video mb-16 bg-gray-100 rounded-lg overflow-hidden shadow-xl">
        <video
          ref={videoRef}
